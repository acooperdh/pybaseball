...
@cache.df_cache()
def pitching_stats_range(start_dt: Optional[str]=None, end_dt: Optional[str]=None) -> pl.DataFrame:
    """
...
def pitching_stats_bref(season: Optional[int]=None) -> pl.DataFrame:
    """
...
def bwar_pitch(return_all: bool=False) -> pl.DataFrame:
    """
